    ...
    return (
      <div className="min-h-screen bg-[#0a1120] pt-28 pb-12 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <Link
            to="/admin/users"
            className="text-[#f9bb1a] text-xs font-bold uppercase tracking-widest hover:underline mt-4 inline-block"
          >
            Back to Users
          </Link>
        </div>
        ...
        <div className="bg-[#121c31]/90 border border-white/10 rounded-2xl p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="mt-1">
                <span
                  className={`text-xs font-bold px-3 py-1 rounded-full ${user.role === "ADMIN" ? "bg-[#f9bb1a]/20 text-[#f9bb1a]" : "bg-white/10 text-white/60"}`}
                >
                  {user.role}
                </span>
              </p>
            ...
            <div>
              ...
              <p className="text-white/60 text-sm font-mono mt-1 break-all">
                {user.id}
              </p>
            </div>
          </div>
